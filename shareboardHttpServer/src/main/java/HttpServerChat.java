 ...
 * Inicia o servidor HTTP para o chat.
 */
public class HttpServerChat {
    static private final String BASE_FOLDER = "shareboardHttpServer/src/main/java/www"; //diretório base do servidor onde os arquivos são armazenados.
    static private ServerSocket sock; // Aguarda as conexões dos clientes.
    private static int nextCardNum = 0;
    private static final ArrayList<Card> CARD_LIST = new ArrayList<>();
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (true) {
            cliSock = sock.accept(); // Aguarda a conexão de um cliente. Bloqueia a execução do programa até que a conexão seja estabelecida.
