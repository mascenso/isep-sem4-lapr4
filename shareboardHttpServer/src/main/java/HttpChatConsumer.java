...
/**
 * Estabelece a conexão com o servidor, lê as mensagens do cliente e envia-as para o servidor.
 */
class HttpChatConsumer {
	...
	public static void main(String args[]) throws Exception {
		...
		msgF.abort(); //para interromper a leitura das mesnagens da consola
		msgF.join(); //espera que a thread termine
	}
...
/**
 *  Faz fetch das mensagens do servidor HTTP (segundo plano).
 */
class MessageFetcher extends Thread {
	...
	/**
	 *  Envia uma requisição GET ao servidor para obter a próxima mensagem.
	 *  Cria uma conexão TCP com o servidor, envia a requisição e recebe a resposta.
	 *  Em seguida, ele fecha a conexão e retorna a mensagem recebida
	 * @return
	 */
