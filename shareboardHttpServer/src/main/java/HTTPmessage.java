 ...
 * Representa uma mensagem HTTP --> uma requisição (pedido) ou uma resposta.
 */
...
public class HTTPmessage {
    ...
    public HTTPmessage(DataInputStream in) throws IOException {
        ...
        isRequest = !firstLine.startsWith("HTTP/"); //se nao começar com HTTP, é requisiçao.
        method = null;
        uri = null;
        content = null;
        status = null;
