...
public class UpdateScheduleRecurringLessonUI extends AbstractUI {
    ...
    protected boolean doShow() {
        ...
        for (RecurringLesson lesson: listOfLessons) {
            System.out.printf("(%d) %s %s %s %s",position, lesson.title(), lesson.startDate().getTime(), lesson.endDate().getTime(), lesson.duration());
        ...
        int duration = Console.readInteger("The old duration is " + lessonList.get(chooseLesson).startDate().toString() + " what value you want to enter?");
