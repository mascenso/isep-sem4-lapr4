...
public class ExamSpecificationLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "DOUBLE", "STRING", "ESC", "NONE", "ONSUBMISSION", 
			"AFTERCLOSING", "ID", "DIGIT", "WS"
		};
	}
	...
	public ExamSpecificationLexer(CharStream input) {
		super(input);
