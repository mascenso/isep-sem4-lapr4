...
public class Question implements AggregateRoot<Designation> {
    ...
    //MATCHING
    protected Question(final String question, final Solution solution, final String[] matchingOptions, final String[] matchingAnswers, final QuestionType questionType) {
    ...
    protected Question(final String question, final Solution solution, final String[] multiOptions, final QuestionType questionType) {
    ...
    //NUMERICAL
    protected Question(final String question, final Solution solution, final String[] multiOptions,
...
/*
   ...
   */
    ...
    //MATCHING
    public static Question valueOf(final String question, final Solution solution, final String[] matchingOptions, final String[] matchingAnswers, final QuestionType questionType){
    ...
    //MULTIPLE_CHOICE
    public static Question valueOf(final String question, final Solution solution, final String[] multiOptions, final QuestionType questionType) {
        Preconditions.nonEmpty(question, "Question cannot be empty");
        Preconditions.nonEmpty((Collection<?>) solution, "Solution cannot be empty");
    ...
    public static Question valueOf(final String question, final Solution solution, final boolean caseSensitive, final QuestionType questionType) {
        Preconditions.nonEmpty(question, "Question cannot be empty");
        Preconditions.nonEmpty((Collection<?>) solution, "Solution cannot be empty");
        Preconditions.nonEmpty(String.valueOf(caseSensitive), "Must define if is case sensitive");
        Preconditions.nonEmpty(Collections.singleton(questionType), "Question type cannot be empty");
        return new Question(question,solution,caseSensitive,questionType);
    }

    //NUMERICAL
    public static Question valueOf(final String question, final Solution solution, final String[] multiOptions,
                       final double acceptanceError, final QuestionType questionType) {
        Preconditions.nonEmpty(question, "Question cannot be empty");
