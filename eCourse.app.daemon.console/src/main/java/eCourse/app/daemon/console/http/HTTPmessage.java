...
public class HTTPmessage {
    ...
    /**
     * Constructor: creates a new HTTPmessage by receiving it from an DataInputStream
     * @param in the DataInputStream from where the message is to be read
     * @throws IOException if TCP connection broken
     */
    ...
    /**
    * Constructor: creates a new empty HTTPmessage
    */
    public HTTPmessage() {
        isRequest=true;
        method=null;
